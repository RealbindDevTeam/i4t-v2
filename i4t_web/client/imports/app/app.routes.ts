...
import { RestaurantRegisterComponent } from './web/administrator/administration/restaurant/register/restaurant-register.component';
import { SettingsWebComponent } from './web/settings/settings/settings.web.component';
import { RestaurantComponent } from './web/administrator/administration/restaurant/restaurant/restaurant.component';
...
import { RestaurantEditionComponent } from './web/administrator/administration/restaurant/edition/restaurant-edition.component';
...
import { MonthlyConfigComponent } from './web/administrator/administration/restaurant/monthly-config/monthly-config/monthly-config.component';
...
import { ReactivateRestaurantComponent } from './web/administrator/payment/reactivate-restaurant/reactivate-restaurant.component';
